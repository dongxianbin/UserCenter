...
#define statusChangeDuration  1.0    //状态改变时间
...
@implementation DXBSuspendWindow
...
- (instancetype)initWithFrame:(CGRect)frame mainImageName:(NSString *)mainImageName imagesAndTitle:(NSDictionary*)imagesAndTitle bgcolor:(UIColor *)bgcolor{
    return  [self initWithFrame:frame mainImageName:mainImageName imagesAndTitle:imagesAndTitle bgcolor:bgcolor animationColor:nil];
}
...
- (void)orientChange:(NSNotification *)notification{
    ...
    self.frame = CGRectMake(0, (kScreenHeight - self.frame.size.height)/2, self.frame.size.width,self.frame.size.height);
